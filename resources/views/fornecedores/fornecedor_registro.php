    ...
    <section class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-header">
                ...
                <form class="form-group3" action="./fornecedor_salvar_editar" method="POST" autocomplete="off">
                        ...
                        <div class="col-12">
                            ...
                            <div class="col-sm col-lg-12">
                                <?php
                                    ...
                                    if(isset($_POST['ver'])){
                                ?>
                                    <a href="./fornecedores" type="reset" class="btn btn-danger" style="margin-bottom: 10px;"><i class="fas fa-reply"></i> Voltar</a>
                                <?php
                                    }else{
                                ?>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-save"></i> Salvar</button>
                                                            
                                <a href="./fornecedores" type="reset" class="btn btn-danger"><i class="fa fa-close"></i> Cancelar</a>
                                    ...
                                    <div class="row" style="margin-top:10px;">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <input class="form-control form-control-lg" type="email" name="email" id="email" value="<?=$cliente[0]['email']?>" style=" text-transform: lowercase;">
                                            </div>
