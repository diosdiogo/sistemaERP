<?php
    $clientes =$pdo->prepare("SELECT * FROM pessoa where idmatriz = :idMatriz and idpessoarelacao = 1 and deletado = 'N' and cliente = 'S';");
                                ...
                                <tr>
                                    ...
                                    <td style="width:140px;">
                                        <div class="row" style="margin-left: 8px;">
                                            ...
                                            <form action="./cliente-registro" method="post" style="float:left;">
                                            ...
                                            <form action="./cliente-salvar-editar" method="POST" style="float:left;">
